...
BLOG_AUTHOR = "Michael Deckebach"  # (translatable)
BLOG_TITLE = "Michael Deckebach"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://michaeldeckebach.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://michaeldeckebach.com/"
BLOG_EMAIL = "michael.deckebach@gmail.com"
BLOG_DESCRIPTION = "Michael Deckebach's website"  # (translatable)
...
POSTS = (
    ("posts/*.rst", "writing", "post.tmpl"),
    ("posts/*.md", "writing", "post.tmpl"),
    ("posts/*.txt", "writing", "post.tmpl"),
    ("posts/*.html", "writing", "post.tmpl"),
)
PAGES = (
    ("pages/*.rst", "", "page.tmpl"),
    ("pages/*.md", "", "page.tmpl"),
...
DEPLOY_COMMANDS = {
    'default': [
        "../virtualenvs/nikola/lib/site-packages/filetreesubs",
    ]
}
...
FAVICONS = (
    ("icon", "/files/favicon-16x16.png", "16x16"),
...
# (translatable)
CONTENT_FOOTER = '&copy; 2017-{date}   |   <a href="mailto:{email}">{email}</a>'
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-8HE6SJQ79H"></script>
<script>
